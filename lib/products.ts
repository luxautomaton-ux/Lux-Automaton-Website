...
export const PRODUCTS: Product[] = [
  ...
  // ── LUX AGENT ────────────────────────────────────────
  {
    ...
    description:
      "A private, business-ready AI agent built with Lux Agent DNA™ — identity, persona, voice, skills, memory, tool boundaries, approvals, unknown-state handling, recovery, and evidence-aware execution inside your secure environment.",
    icon: "🤖",
    status: "live",
    accentColor: "var(--green)",
    features: [
      "Lux Agent DNA™ identity + persona contracts",
      "Voice-ready agent profiles + explicit fallback",
      "Success Packs + Memory Packs + Voice Packs",
      "Tool contracts + least-privilege permissions",
      "Unknown-state handling + human escalation",
      "Recovery, receipts, edge-case tests + Lux Verify™",
    ],
    prices: [],
